...
const ProfilePage = (props) => {
  ...
  return (
    <div className="container ">
      ...
      <div className="row ">
        <div className="container d-flex bodyColor p-3 profileBody">
          <div className="col-sm-3 d-flex flex-column  align-items-center profileUserSection">
            ...
            <div className="d-flex justify-content-between align-items-center w-100 options">
          ...
          <div className="col-sm-6  borderColor galleryBgr galleryshadow p-2 mb-3">
            <div className="container  p-2 d-flex flex-wrap justify-content-between">
              {userImage.map((image) => (
                <Link
                  to={`/single-image/${image._id}`}
                  className="galleryImg d-flex justify-content-center align-items-center mb-2 "
                >
                  <img
          ...
          <div className="col-sm-3  d-flex flex-column justify-content-around align-items-center">
